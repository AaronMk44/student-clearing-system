...
if (
  ...
  $studentID = InputFilter::sanitizeField($_POST['studentID']);
...
<head>
  ...
  <title>Delete Student | Clearing System</title>
          ...
          <div class="container flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="card-title text-primary">Delete Student</h5>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  <p>
                    Are you sure you want to delete <?= $student->firstName ?>'s Account?
                  </p>
                  <input type="hidden" name="studentID" value="<?= $_REQUEST['student_id'] ?>">
