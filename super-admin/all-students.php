        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        ...
                        <p class="mb-4">
                          Manage all <span class="fw-bold">students</span> from one place.
                        </p>
                      </div>
                    </div>
              ...
              <div class="col-lg-3">
                <a href="./create-student.php" class="btn btn-primary mx-auto">+ New Student</a>
              </div>
            </div>
            <div class="card">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <?php foreach ($students as $s) : ?>
                      ...
                      <tr>
                        ...
                        <td><?= $s->email ?></td>
                        <td>
                          <a href="./edit-student.php?student_id=<?= $s->studentID ?>">Edit</a>/
                          <a class="text-danger" href="./delete-student.php?student_id=<?= $s->studentID ?>">Delete</a>
                        </td>
                      </tr>
