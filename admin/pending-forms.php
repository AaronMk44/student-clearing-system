...
$forms = $fm->getPendingFormsForAdmin($admin->adminRole);
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                <h4 class="pt-3">Admin Clearing System :: <?= strtoupper($admin->adminRole) ?> Portal</h4>
              </div>
            </div>
            <!-- /Search -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <p class="mb-4">
                  Explore the collection of clearance <span class="fw-bold">forms</span> from previous months. Approve a new clearance request whenever needed.
                </p>
              </div>
            </div>
            <div class="card">
